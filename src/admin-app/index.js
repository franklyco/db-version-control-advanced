        ...
        var e, t = {
          435: () => {
            const e = window.wp.element, t = window.wp.components, s = window.ReactJSXRuntime, TooltipWrapper = ({content: n, placement: i = "top", children: l}) => {
              ...
              const t = e?.entity_title || e?.entity_path || "Bricks template", s = e?.context?.title || e?.context?.name || e?.context?.slug || `source #${e?.source_id || "?"}`, n = e?.kind || "reference", i = e?.status || "unknown", l = e?.path || "unknown path", a = e?.local_id ? ` → local #${e.local_id}` : "";
                ...
                children: [ nt.length > 0 && (0, s.jsx)("div", {
                  ...
                  children: [ (0, s.jsx)("h2", {
                    ...
                    children: [ (0, s.jsxs)("p", {
                      ...
                      className: "dbvc-preflight-list",
                      children: bricksReferenceProblemRows.slice(0, 5).map((e, t) => (0, s.jsx)("li", {
                        children: formatBricksReferenceRow(e)
