...
## Companion Docs
- UI structure and component hierarchy blueprint: `docs/architecture/admin-app-ui-architecture.md`
- Implementation ticket seed (component `props/events/state/dependencies` contracts): `docs/architecture/admin-app-ui-architecture.md#component-contracts-implementation-ticket-seed`
- Epic parity audit table: `docs/architecture/admin-app-ui-architecture.md#refractor-coverage-matrix`
...
- [ ] Define and document a shared attribute convention in `docs/architecture/admin-app-ui-architecture.md` (e.g., `data-component`, `data-slot`, `data-entity-id`, `data-field-key`, `data-change-type`, `data-decision-state`, `data-resolver-state`).
