...
define('DBVC_PLUGIN_VERSION', '1.8.3');
...
require_once DBVC_PLUGIN_PATH . 'includes/class-third-party-portability.php';
...
require_once DBVC_PLUGIN_PATH . 'includes/Dbvc/ConfigurationPortability/Providers/CoreImportExportProvider.php';
require_once DBVC_PLUGIN_PATH . 'includes/Dbvc/ConfigurationPortability/Providers/MaskingProvider.php';
require_once DBVC_PLUGIN_PATH . 'includes/Dbvc/ConfigurationPortability/Providers/ThirdPartyPortabilitySettingsProvider.php';
require_once DBVC_PLUGIN_PATH . 'includes/Dbvc/ConfigurationPortability/Providers/BricksAddonProvider.php';
require_once DBVC_PLUGIN_PATH . 'includes/Dbvc/ConfigurationPortability/Providers/MasterToolsProvider.php';
require_once DBVC_PLUGIN_PATH . 'includes/Dbvc/ConfigurationPortability/Providers/AiPackageProvider.php';
