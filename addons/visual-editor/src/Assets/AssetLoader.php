        ...
        wp_localize_script(
            ...
            [
                ...
                'strings' => [
                    ...
                    'toolbarSharedGlobalsEmpty' => __('No shared global relationship or post object fields are marked on this page.', 'dbvc'),
                    'toolbarSharedGlobalsNotice' => __('Configured shared option-owned relationship/post_object fields are listed here with verified ACF metadata. Saving uses the existing field panel, shared acknowledgement, and reload-after-save flow.', 'dbvc'),
