        ...
        wp_localize_script(
            ...
            [
                ...
                'strings' => [
                    ...
                    'panelRichTextFormat' => __('Block format', 'dbvc'),
                    'panelRichTextHeading1' => __('Heading 1', 'dbvc'),
                    'panelRichTextHeading2' => __('Heading 2', 'dbvc'),
                    'panelRichTextHeading3' => __('Heading 3', 'dbvc'),
                    'panelRichTextHeading4' => __('Heading 4', 'dbvc'),
                    'panelRichTextHeading5' => __('Heading 5', 'dbvc'),
                    'panelRichTextHeading6' => __('Heading 6', 'dbvc'),
                    'panelRichTextPreformatted' => __('Preformatted', 'dbvc'),
