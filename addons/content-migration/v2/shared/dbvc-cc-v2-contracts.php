...
final class DBVC_CC_V2_Contracts
{
    ...
    public static function get_field_context_settings()
    {
        ...
        $integration_mode = (string) get_option(self::OPTION_FIELD_CONTEXT_INTEGRATION_MODE, $defaults[self::OPTION_FIELD_CONTEXT_INTEGRATION_MODE]);
        if (! in_array($integration_mode, self::get_allowed_field_context_modes(), true)) {
            $integration_mode = self::FIELD_CONTEXT_MODE_AUTO;
        }
