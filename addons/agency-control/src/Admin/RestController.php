...
final class RestController
{
    ...
    private const READS = ['status', 'environments', 'events', 'projections', 'subscriptions', 'deliveries', 'reviews', 'compare', 'baselines', 'links', 'definitions', 'overrides', 'framework_status', 'releases', 'preparations', 'approvals', 'invitations'];

    /** @var array<int, string> Inspector methods exposed as POST. */
    private const WRITES = ['invite', 'revoke', 'release', 'hold', 'subscribe', 'subscribe_framework', 'route', 'baseline_confirm', 'link_instance', 'unlink_instance', 'definition_publish', 'definition_desire', 'adopt_version', 'override_approve', 'override_detach', 'review_classify', 'review_resolve', 'release_create', 'release_withdraw', 'prepare_request', 'approve', 'revoke_approval'];
