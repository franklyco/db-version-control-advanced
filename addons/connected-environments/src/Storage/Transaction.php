 ...
 * Select it with the `dbvc_connected_transaction_strategy` filter. On a
...
{
    private const SAVEPOINT = 'dbvc_connected_observation';
    ...
    {
        $strategy = apply_filters('dbvc_connected_transaction_strategy', 'transaction');
