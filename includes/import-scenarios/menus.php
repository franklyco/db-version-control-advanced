...
class DBVC_Import_Scenario_Menus implements DBVC_Import_Scenario
{
    ...
    public function route(array $file, array $payload, array $context): array
    {
        ...
        $target_path = $sync_dir . 'menus.json';
...
return new DBVC_Import_Scenario_Menus();
