...
final class MediaHandlingProvider extends AbstractOptionDomainProvider
{
        ...
        return [
            ...
            'media_hydration' => [
                ...
                'fields' => [
                    ...
                    HydrationSettings::OPTION_EXECUTION_MODE,
                    ...
                    HydrationSettings::OPTION_NORMALIZE_MEDIA_URLS_TO_HTTPS,
    ...
    public function get_fields(): array
    {
        return [
            ...
            HydrationSettings::OPTION_EXECUTION_MODE => Field::select(HydrationSettings::OPTION_EXECUTION_MODE, __('Hydration execution mode', 'dbvc'), 'media_hydration', 'browser_chunks', HydrationSettings::allowed_execution_modes()),
